...
run_dir=Path(r'C:\Users\ELANOR\Documents\ThermoCalc_OpenClaw\oxide_macros_tcox12\maps\\CAMA_5CAF2')
macro=Path(r'C:\Users\ELANOR\Documents\ThermoCalc_OpenClaw\oxide_macros_tcox12\maps\\CAMA_5CAF2\map_CAMA_5CAF2_tcox12.tcm')
...
print('MAP_'+r'CAMA_5CAF2'+'='+str(p.returncode))
